...
# Não importaremos os orquestradores abaixo, já que não vamos usar
...
from scripts.landing.holliday_landing import HolidayExtractorOrchestrator
...
def holiday_pipeline():
    ...
    def extract_holidays() -> Dict:
        ...
        return HolidayExtractorOrchestrator.run_extraction()

    # Comentar as próximas tarefas
    ...
    # Defina o fluxo de execução
    landing_result = extract_holidays()
    # Comentar as chamadas das outras tarefas
